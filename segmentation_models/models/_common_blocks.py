...
class SelfAttention2D(keras.layers.Layer):
    def __init__(self, depth_k, depth_v, num_heads, relative, **kwargs):
        ...
        downsample : downsample kqv matrix. If 
            downsample = 0 : Downsample and does not upsample
            downsample = 1 : Downsample and upsample
            downsample = 2 : Does not downsample, using the full input
