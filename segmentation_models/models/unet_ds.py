...
from ._common_blocks import Conv2dBn, SelfAttention, MultiHeadAttention, Scale
...
def DecoderUpsamplingX2BlockMHA(filters, stage, use_batchnorm=False, Rk=1, Rv =1, Nh = 8):
